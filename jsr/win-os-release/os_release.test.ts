...
import {  WinOsRelease } from "./mod.ts";
...
test("win-os-release::getOsReleaseText returns os-release fields", { skip: !WINDOWS }, () => {
...
test("win-os-release::getOsReleaseJson matches os-release text", { skip: !WINDOWS }, () => {
...
test("win-os-release::getOsReleaseJson variant is valid", { skip: !WINDOWS }, () => {
    const json = WinOsRelease.getOsReleaseJson();
