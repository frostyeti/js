...
NIST SP 800-63B requirements, while the secret masker protects sensitive data
in logs and output.
...
```typescript
import { DefaultSecretGenerator, generateSecret, secretGenerator } from "@frostyeti/secrets";
