...
export const AnsiModes = {
    ...
    equals: function (a: AnsiMode, b: AnsiMode | number | string): boolean {
        if (typeof b === "string") {
            return a === this.toValue(b) as AnsiMode;
 ...
 * ```
 */
export function equals(a: AnsiMode, b: AnsiMode | number | string): boolean {
