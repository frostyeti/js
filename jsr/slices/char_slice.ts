 ...
 * ```
 */
export function charSlice(buffer: Uint32Array | number[] | string, start?: number, end?: number): CharSlice {
 ...
 * ```
 */
export function readonlyCharSlice(buffer: Uint32Array | number[] | string, start?: number, end?: number): ReadonlyCharSlice {
    if (typeof buffer === "string") {
