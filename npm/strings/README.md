...
```typescript
import { equalFold, indexOf, startsWithFold } from "@frostyeti/strings";
...
```typescript
import { camelize, dasherize, titleize, underscore } from "@frostyeti/strings";
...
[dreamerslab/node.inflection](https://github.com/dreamerslab/node.inflection)
which is under the
