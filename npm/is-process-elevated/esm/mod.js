...
let isElevated = function (cache = true) {
  return false;
};
switch (RUNTIME) {
  case "deno":
    isElevated = (await import("./deno.js")).evalIsProcessElevated;
    break;
  case "node":
    isElevated = (await import("./node.js")).evalIsProcessElevated;
    break;
  case "bun":
    isElevated = (await import("./bun.js")).evalIsProcessElevated;
    break;
}
/**
 ...
 * ```
 */
export function isProcessElevated(cache = true) {
