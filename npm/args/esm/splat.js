 ...
 * @module
 */
import { dasherize } from "@frostyeti/strings/dasherize";
...
export function splat(object, options) {
  ...
  if (
    object[SplatSymbols.argNames] &&
    Array.isArray(object[SplatSymbols.argNames])
  ) {
  ...
  if (
    object[SplatSymbols.remainingArgs] &&
    Array.isArray(object[SplatSymbols.remainingArgs])
  ) {
    remainingArgs = object[SplatSymbols.remainingArgs];
  }
  if (
    object[SplatSymbols.extraArgs] &&
    Array.isArray(object[SplatSymbols.extraArgs])
  ) {
