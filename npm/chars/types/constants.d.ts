 ...
 * @example
 * ```ts
 * import { CHAR_UPPERCASE_A } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_LOWERCASE_A } from "@frostyeti/chars";
 *
 * const char = "apple".charCodeAt(0);
 ...
 * @example
 * ```ts
 * import { CHAR_UPPERCASE_Z } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_LOWERCASE_Z } from "@frostyeti/chars";
 *
 * const char = "zebra".charCodeAt(0);
 ...
 * @example
 * ```ts
 * import { CHAR_DOT } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_FORWARD_SLASH } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_BACKWARD_SLASH } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_VERTICAL_LINE } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_COLON } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_QUESTION_MARK } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_UNDERSCORE } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_LINE_FEED } from "@frostyeti/chars";
 *
 * const char = "line1\nline2".charCodeAt(5);
 ...
 * @example
 * ```ts
 * import { CHAR_CARRIAGE_RETURN } from "@frostyeti/chars";
 *
 * const char = "line1\r\n".charCodeAt(5);
 ...
 * @example
 * ```ts
 * import { CHAR_TAB } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_FORM_FEED } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_EXCLAMATION_MARK } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_HASH } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_SPACE } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_NO_BREAK_SPACE } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_ZERO_WIDTH_NOBREAK_SPACE } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_LEFT_SQUARE_BRACKET } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_RIGHT_SQUARE_BRACKET } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_LEFT_ANGLE_BRACKET } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_RIGHT_ANGLE_BRACKET } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_LEFT_CURLY_BRACKET } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_RIGHT_CURLY_BRACKET } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_HYPHEN_MINUS } from "@frostyeti/chars";
 *
 * const char = "a-b".charCodeAt(1);
 ...
 * @example
 * ```ts
 * import { CHAR_PLUS } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_DOUBLE_QUOTE } from "@frostyeti/chars";
 *
 * const char = '"hello"'.charCodeAt(0);
 ...
 * @example
 * ```ts
 * import { CHAR_SINGLE_QUOTE } from "@frostyeti/chars";
 *
 * const char = "'hello'".charCodeAt(0);
 ...
 * @example
 * ```ts
 * import { CHAR_PERCENT } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_SEMICOLON } from "@frostyeti/chars";
 *
 * const char = "a;b".charCodeAt(1);
 ...
 * @example
 * ```ts
 * import { CHAR_CIRCUMFLEX_ACCENT } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_GRAVE_ACCENT } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_AT } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_AMPERSAND } from "@frostyeti/chars";
 *
 * const char = "a&b".charCodeAt(1);
 ...
 * @example
 * ```ts
 * import { CHAR_TILDA } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_DOLLAR } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_VERTICAL_TAB } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_ASTERISK } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_COMMA } from "@frostyeti/chars";
 *
 * const char = "a,b".charCodeAt(1);
 ...
 * @example
 * ```ts
 * import { CHAR_EQUAL } from "@frostyeti/chars";
 *
 * const char = "a=b".charCodeAt(1);
 ...
 * @example
 * ```ts
 * import { CHAR_0 } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { CHAR_9 } from "@frostyeti/chars";
 *
 ...
 * @example
 * ```ts
 * import { MAX_RUNE, isChar } from "@frostyeti/chars";
 *
