...
test("ansi::apply() with unicode", function () {
  equal(
    c.apply("🎨 Art", c.bold, c.cyan),
    "\x1b[36m\x1b[1m🎨 Art\x1b[22m\x1b[39m",
  );
});
...
test("ansi::rgb24() boundary RGB values", function () {
  ...
  equal(
    c.rgb24("test", { r: 255, g: 255, b: 255 }),
    "\x1b[38;2;255;255;255mtest\x1b[39m",
  );
});
test("ansi::rgb24() clamps out of range values", function () {
  equal(
    c.rgb24("test", { r: -10, g: 300, b: 128 }),
    "\x1b[38;2;0;255;128mtest\x1b[39m",
  );
});
...
test("ansi::deeply nested styles with unicode", function () {
  ...
  equal(
    nested,
    "\x1b[44m\x1b[1m\x1b[3m\x1b[33m🌟 Star\x1b[39m\x1b[23m\x1b[22m\x1b[49m",
  );
});
...
test("ansi::defineColor() and defineBgColor() combined", function () {
  ...
  equal(
    styled,
    "\x1b[48;2;128;0;128m\x1b[38;2;255;140;0mHalloween\x1b[39m\x1b[49m",
  );
  AnsiSettings.current.mode = originalMode;
});
