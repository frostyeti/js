 ...
 * @module
 */
export { setBackend, WinOsRelease } from "./os_release.js";
export {
  MachineRole,
  ProductEdition,
  ProductType,
...
import { setBackend } from "./os_release.js";
// ── Runtime detection & backend auto-loading ────────────────────────────────
// deno-lint-ignore no-explicit-any
const g = globalThis;
async function loadBackend() {
  if (g.Deno !== undefined) {
    const mod = await import("./ffi_deno.js");
    return mod.backend;
  }
  if (g.Bun !== undefined) {
    const mod = await import("./ffi_bun.js");
    return mod.backend;
  }
  // Node.js (or compatible) -- use koffi
  const mod = await import("./ffi_node.js");
  return mod.backend;
}
