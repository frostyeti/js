...
The `ci-env` enables determining if you are within a ci pipeline and has
utilties such as writing logs or setting environment variables for different ci
tools.

This module will evolve over time to enable using common ci environment
variables and make it easier to deal with secrets, environment variables and
